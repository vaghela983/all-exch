(function () {
  ...
  /**
   * Testimonials slider (Live Casino)
   */
  new Swiper(".live-casino-slider", {
    speed: 600,
    loop: true,
    autoplay: {
      delay: 5000,
  ...
  $(document).ready(function () {
    ...
    $(document).on("click", "#demoLogin", function () {
      $("#username").val("kingtest");
      $("#password").val("Abcd@1234");
      $("#login-form").submit();
    });
  });
})();
